...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-0111-questions-in-geometric-group-theory-q-7af5f344",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-0111-4bf8e7701bcd",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-0111"
      }
    ],
    "statement": {
      "language": "en",
      "text": "(Whyte) Let Γ be a 1-ended hyperbolic group which is not virtually a surface group. Can every infinite index subgroup be free?",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 1.11",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "ad077177caf528abb5eaf12d6a095d7da9ecd5e89ab3ee6fa754d99a7a50d2e9"
}
```
